...
- **design-api-review** — Review only. Checks an existing OpenAPI spec against your standards and best practices, and reports every divergence with a citation to the rule it breaks. Use on specs written by hand, generated by another tool, inherited, or gone stale after your standards changed. Reports first; fixes only what you approve.
